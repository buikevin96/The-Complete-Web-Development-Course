...
if($believeinyourdream) {
    ...
    echo "Believe in your dream to be sucessful in life.";
}
...
switch($strength){
    case "belief":
        echo "<p>You have core values that are unchanging. They will define your purpose in life.";
        break;
    case "communication":
    ...
    case "competition":
        ...
        break;
    default:
        echo "<p>Choose a strentgh, you have many for sure</p>";
        break;
}
?>
